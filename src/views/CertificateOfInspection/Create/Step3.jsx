...
const Step3 = ({ goodsCombo, setErrors, errors, inputsData, setInputsData, showWarningdissuasion, setShowWarningDissuasion }) => {
    ...
    return (
        <>
            ...
            {/* {(stepsOfCreatePage?.ICO > 2 || stepsOfCreatePage?.ICO === 2) && (<Step3 />)} */}
        </>
    )
}
